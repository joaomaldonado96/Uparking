<template>
<div class="alto" >
                <v-card-media src="https://static.panoramio.com.storage.googleapis.com/photos/large/6667022.jpg" height="200px">
                      </v-card-media>

                        <div class="text-xs-center">
                          <h3 class="display-3">Parqueadero del Luis A. Calvo</h3>
...
export default {
  ...
  created() {
    axios.get('http://localhost:3000/api/zona/3').then(response => {
  ...
  methods:{
      ...
      postPost() {
        ...
        axios.put('http://localhost:3000/api/zona/3', {nombre:this.nombre,
